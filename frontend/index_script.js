...
// Accept: +1 (416) 555-0199 / 416-555-0199 / 4165550199 / +44 7911 123456
function validatePhone(phone) {
    const digits = phone.replace(/\D/g, '');
    return digits.length >= 10 && digits.length <= 15;
}

// Reject: fake email domains
...
// Test: Password Strength Check { score 0-5, checks {} }
...
const STRENGTH_META = [
    { label: '',          color: '#e0e0e0' },   // 0
    { label: 'Very Weak', color: '#e74c3c' },   // 1
    { label: 'Weak',      color: '#e67e22' },   // 2
    { label: 'Fair',      color: '#f1c40f' },   // 3
    { label: 'Strong',    color: '#2ecc71' },   // 4
    { label: 'Very Strong', color: '#27ae60' }, // 5
];
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function checkConfirmMatch() {
        ...
        setFieldMsg('confirm-msg', confirmInput.value
    ...
    if (signupForm) {
        signupForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                setFormMsg('signup-msg', 'Could not reach the server. Please check your connection.', 'error');
            } finally {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                setFormMsg('login-msg', 'Could not reach the server. Please check your connection.', 'error');
            } finally {
